...
-- 3) Find the apps with the highest number of reviews.
SELECT
	DISTINCT App,
	Category,
	Reviews
...
-- 5) Total amount of revenue generated by Google Playstore by hosting apps.
SELECT
...
-- 7) Find the genre with the most number of published apps.
SELECT
	Genres,
...
-- 9) Identify the best gaming app (the best = having the highest number of reviews).
SELECT
	App,
    Reviews
FROM playstore
...
-- 10) Analyze the average sentiment polarity of user reviews for each app category.
SELECT
	Category,
...
-- 11) Provide the distribution of sentiments across different app categories.
SELECT
	Category,
    Sentiment,
...
-- 12) Extract all negative sentiment reviews for 'Clash of Clans' with their sentiment polarity and sentiment subjectivity
SELECT
	Translated_Review,
    sentiment_polarity,
